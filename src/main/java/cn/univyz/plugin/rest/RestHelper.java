...
public class RestHelper {
    ...
    //发布REST服务
    public static void publicshService(String wadl, Class<?> resouceClass) {
        JAXRSServerFactoryBean factory = new JAXRSServerFactoryBean();
        factory.setAddress(wadl);
        factory.setResourceClasses(resouceClass);
        factory.setResourceProvider(resouceClass, new SingletonResourceProvider(BeanHelper.getBean(resouceClass)));
